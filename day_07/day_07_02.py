...
def is_five_of_a_kind(hand):
    ...
    return len(hand_set) == 1 or (counts.count(5-joker_count) == 1)
...
def is_four_of_a_kind(hand):
    ...
    joker_count = hand.count('J')
    counts = [hand.count(card) for card in hand_set]
    return (any(hand.count(card) == 4 for card in hand_set)
            or ((counts.count(2) == 2 and joker_count == 2) or (counts.count(3) == 1 and joker_count == 1) or (joker_count >= 3)))
...
def is_full_house(hand):
    ...
    joker_count = hand.count('J')
    counts = [hand.count(card) for card in hand_set]
    return set(counts) == {2, 3} or (counts.count(2) == 2 and 'J' in hand_set)
...
def is_three_of_a_kind(hand):
    ...
    joker_count = hand.count('J')
    counts = [hand.count(card) for card in hand_set]
    return (counts.count(3) == 1) or (counts.count(2) == 1 and joker_count == 1) or (counts.count(1) >= 1 and joker_count == 2)
...
def is_two_pair(hand):
    ...
    joker_count = hand.count('J')
    counts = [hand.count(card) for card in hand_set]
    return (counts.count(2) == 2 and counts.count(1) == 1) or (counts.count(2) == 1 and counts.count(1) == 3 and 'J' in hand_set)


def is_one_pair(hand):
    hand_set = set(hand)
    counts = [hand.count(card) for card in hand_set]
    return (counts.count(2) == 1 and counts.count(1) == 3) or ('J' in hand_set)
